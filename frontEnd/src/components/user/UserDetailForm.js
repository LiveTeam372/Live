...
const UserDetailForm = ({ setView, email }) => {
  ...
  const [userMarried, setUserMarried] = useState('N');
  const [interestAddrs, setInterestAddrs] = useState([]);
  ...
  const [isCheckedNickName, setIsCheckedNickName] = useState(false); // 닉네임 조회 여부
            ...
            <form onSubmit={userDetailSubmit}>
              <div style={{marginTop: "30px"}}>
                ...
                <div className="row">
                  ...
                  <div className="col-8">
                    <input type="text" className="form-control" placeholder="10자 이내" name="nickName" maxLength="10" required onChange={checkNickName}/>
                  </div>
                  <div className="col-2">
